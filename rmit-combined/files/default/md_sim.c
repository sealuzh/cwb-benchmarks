...
/*
  ...
  Author:
    ...
    Added workload size np and step_num as configurable cli parameter by Joel Scheuner

  Parameters:

    np [integer optional] Size of the simulation (defaults to 10000)
    step_num [integer optional] Number of simulation time steps (defaults to 400)
*/
{
  int np = 10000;
  int step_num = 400;
